...
class Routes {
  static String checkAuth = '/checkAuth';
  static String login = '/auth/login';
  static String dashBoardSuperAdmin = '/super_admin/home';
  static String dashBoardHandleComplexHousing = '/handle_complex_housing/home';
}
